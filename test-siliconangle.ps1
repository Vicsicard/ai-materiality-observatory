$url = 'https://siliconangle.com/2026/06/02/ai-agents-open-data-governance-take-center-stage-snowflake-summit/'
...
$response | ConvertTo-Json -Depth 10 | Out-File -FilePath 'C:\Users\digit\CascadeProjects\ai-materiality-observatory\siliconangle-response.json' -Encoding UTF8

Write-Host 'Response saved to siliconangle-response.json'
