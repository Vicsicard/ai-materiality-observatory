$url = 'https://techcrunch.com/2026/06/02/microsoft-ai-infrastructure-investment/'
...
$response | ConvertTo-Json -Depth 10 | Out-File -FilePath 'C:\Users\digit\CascadeProjects\ai-materiality-observatory\techcrunch-response.json' -Encoding UTF8

Write-Host 'Response saved to techcrunch-response.json'
