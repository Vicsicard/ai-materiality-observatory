$url = 'https://www.aljazeera.com/economy/2026/6/2/ai-chips-global-supply-chain-concerns/'
...
$response | ConvertTo-Json -Depth 10 | Out-File -FilePath 'C:\Users\digit\CascadeProjects\ai-materiality-observatory\aljazeera-2-response.json' -Encoding UTF8

Write-Host 'Response saved to aljazeera-2-response.json'
